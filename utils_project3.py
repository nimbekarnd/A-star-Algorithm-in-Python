...
class Astar(object):
    ...
    def ActionMoveStraight(self, currRow,currCol):
        theta = 0
    ...
    def CheckIfGoal(self, currRow, currCol):
        check = (((currRow - self.goal[0]) * (currRow - self.goal[0])) + ((currRow - self.goal[1]) * (currRow - self.goal[1])) - ( 1.5 * 1.5))
        if(check <= 0):
            print("goal reached")
            return True
        else:
    ...
    def Astar(self):
        ...
        while(len(queue) > 0):
            ...
            if(self.ActionMove30Up(currNode[0], currNode[1], currNode[2]) and visited[(currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)] == False and (distMap[(currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)] > distMap[currNode] + 1)):
                print("hi")
                distMap[(currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)] = distMap[currNode] + 1
                path[(currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)] = currNode
                heappush(queue, (distMap[(currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)], (currNode[0] - 0.5, currNode[1] + 1, currNode[2] + 30)))

            if(self.ActionMove60Up(currNode[0], currNode[1], currNode[2]) and visited[(currNode[0] - 1, currNode[1] + 0.5, currNode[2] + 60)] == False and (distMap[(currNode[0] - 1, currNode[1] + 0.5, currNode[2] + 60)] > distMap[currNode] + 1)):
                distMap[(currNode[0] - 1, currNode[1] + 0.5, currNode[2] + 60)] = distMap[currNode] + 1
                path[(currNode[0] - 1, currNode[1] + 0.5, currNode[2] + 60)] = currNode
                heappush(queue, (distMap[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)], (currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)))

            if(self.ActionMove30Down(currNode[0], currNode[1], currNode[2]) and visited[(currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)] == False and (distMap[(currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)] > distMap[currNode] + 1)):
                distMap[(currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)] = distMap[currNode] + 1
                path[(currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)] = currNode
                heappush(queue, (distMap[(currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)], (currNode[0] + 0.5, currNode[1] + 1, currNode[2] + 30)))

            if(self.ActionMove60Down(currNode[0], currNode[1], currNode[2]) and visited[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)] == False and (distMap[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)] > distMap[currNode] + 1)):
                distMap[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)] = distMap[currNode] + 1
                path[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)] = currNode
                heappush(queue, (distMap[(currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)], (currNode[0] + 1, currNode[1] + 0.5, currNode[2] + 60)))
